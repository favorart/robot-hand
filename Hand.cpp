...
{ double frame = stepFrame (hydNo, time, atStop);
  ...
  { // default: SetError_ (ERR_NO);                                             break;
    case ClvclOpn : shiftClvcl = (shiftClvcl_ + frame > maxClvclShift) ? (maxClvclShift - shiftClvcl_) :  frame; break; 
    case ClvclCls : shiftClvcl = (shiftClvcl_ - frame < 0.0          ) ? (          0.0 - shiftClvcl_) : -frame; break;
    case ShldrOpn : angleShldr = (angleShldr_ - frame < 1.0          ) ? (          1.0 - angleShldr_) : -frame; break;
    case ShldrCls : angleShldr = (angleShldr_ + frame > maxShldrAngle) ? (maxShldrAngle - angleShldr_) :  frame; break;
    case ElbowOpn : angleElbow = (angleElbow_ - frame < 1.0          ) ? (          1.0 - angleElbow_) : -frame; break; 
    case ElbowCls : angleElbow = (angleElbow_ + frame > maxElbowAngle) ? (maxElbowAngle - angleElbow_) :  frame; break;
...
//--------------------------------------------------------------------------------
Hand::MusclesEnum  OldHand::selectHandMove (uint_t choose)
{
...
Hand::MusclesEnum  OldHand::operator| (Hand::MusclesEnum m, Hand::MusclesEnum k)
...
std::ostream&  OldHand::operator<< (std::ostream &out, Hand::MusclesEnum muscle)
{
...
std::ostream&  OldHand::operator<< (std::ostream &out, Hand::JointsEnum   joint)
{
...
//--------------------------------------------------------------------------------
bool  OldHand::muscleValidAtOnce (Hand::MusclesEnum muscle)
{
  if ( !muscle
...
//--------------------------------------------------------------------------------
Hand::MusclesEnum  OldHand::muscleByJoint (Hand:: JointsEnum joint, bool open)
{
...
Hand:: JointsEnum  OldHand::jointByMuscle (Hand::MusclesEnum muscle)
{
